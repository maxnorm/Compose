# LibERC20
[Git Source](https://github.com/maxnorm/Compose/blob/ff0903436c4e0119526128efec4dad880d20e793/src/token/ERC20/ERC20/LibERC20.sol)

**Title:**
LibERC20 — ERC-20 Library

Provides internal functions and storage layout for ERC-20 token logic.
...
Increases both total supply and the recipient's balance.
...
## Structs
### ERC20Storage
ERC-20 storage layout using the ERC-8042 standard.
