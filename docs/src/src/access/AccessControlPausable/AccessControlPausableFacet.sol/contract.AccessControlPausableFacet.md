...
[Git Source](https://github.com/maxnorm/Compose/blob/e3e377cf3d77e94dc30e10812da2bdd1907ca159/src/access/AccessControlPausable/AccessControlPausableFacet.sol)
...
Temporarily disables a role, preventing all accounts from using it.

Only the admin of the role can pause it.
Emits a [RolePaused](//home/mn/os-contribution/Compose/docs/src/src/access/AccessControlPausable/AccessControlPausableFacet.sol/contract.AccessControlPausableFacet.md#rolepaused) event.
...
Re-enables a role that was previously paused.

Only the admin of the role can unpause it.
Emits a [RoleUnpaused](//home/mn/os-contribution/Compose/docs/src/src/access/AccessControlPausable/AccessControlPausableFacet.sol/contract.AccessControlPausableFacet.md#roleunpaused) event.
...
Checks if an account has a role and if the role is not paused.
