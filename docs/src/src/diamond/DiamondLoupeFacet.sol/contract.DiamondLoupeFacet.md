# DiamondLoupeFacet
[Git Source](https://github.com/maxnorm/Compose/blob/6956906c9ed86d52ca90b8f2deea310beff37f02/src/diamond/DiamondLoupeFacet.sol)
...
Returns the set of selectors that this diamond currently routes to the
given facet address.
How it works:
...
This function returns the unique set of facet addresses that provide functionality
to the diamond.
**How it works:**
...
Returns each unique facet address currently used by the diamond and the
...
|Name|Type|Description|
|----|----|-----------|
|`facetsAndSelectors`|`Facet[]`|Array of Facet structs, each containing a facet address.|
