...
LibERC20Bridgeable provides foundational functionality for bridging ERC20 tokens in a diamond-based smart contract system. It defines core methods for cross-chain minting and burning while integrating role-based access control to ensure only trusted bridges can invoke critical functions.


[View Source](https://github.com/maxnorm/Compose/blob/7206f045d711880c211b967e80d72745b52f5cfc/src/token/ERC20/ERC20Bridgeable/LibERC20Bridgeable.sol)
...
import { LibERC20Bridgeable } from &quot;./LibERC20Bridgeable.sol&quot;;
...
- Ensure all address inputs are validated, especially for cross-chain operations.
- Restrict access to crosschainMint and crosschainBurn to addresses holding the `trusted-bridge` role.
- Frequently review and update the list of trusted bridges to maintain system integrity.
</Callout>
...
LibERC20Bridgeable interacts with the diamond storage pattern by mapping specific functions to predefined storage slots. Changes made to storage through this library are immediately visible to facets, ensuring seamless integration across the diamond.
</Callout>
