...
gitSource: "https://github.com/maxnorm/Compose/blob/326d9e4b8d8f7ef437a77f59f91bb1619c2d1a6c/src/access/OwnerTwoSteps/OwnerTwoStepsMod.sol"
---
...
- Implements secure two-step ownership transfer in compliance with ERC-173.
- Accessible storage pointers ensure compatibility with diamond facets.
- Supports renouncing ownership to disallow any privileged access.
</Callout>
...
The OwnerTwoStepsMod library provides ERC-173 compliant two-step ownership management for Compose diamonds or modular contracts. It ensures safe ownership transfers by requiring explicit acceptance from the new owner, reducing the risk of accidental or unauthorized ownership changes.
...
contract OwnershipFacet {
    function initiateOwnerTransfer(address _newOwner) external {
...
- Always validate new owner addresses before calling &#x60;transferOwnership&#x60; to avoid using invalid addresses.
- Call &#x60;acceptOwnership&#x60; promptly after initiating a transfer to ensure ownership continuity.
- Explicitly check ownership using &#x60;requireOwner&#x60; to guard sensitive operations in facets.
</Callout>

## Integration Notes

<Callout type="success" title="Shared Storage">
The &#x60;OwnerTwoStepsMod&#x60; library uses the diamond storage pattern to store &#x60;owner&#x60; and &#x60;pendingOwner&#x60; data. It interacts with specific storage slots (&#x60;OWNER_STORAGE_POSITION&#x60; and &#x60;PENDING_OWNER_STORAGE_POSITION&#x60;), making the state visible to other facets using the same storage conventions. Ensure no overlapping storage slot definitions when integrating additional modules. Always test ownership flows as improper state initialization or slot conflicts can lead to loss of ownership control.
</Callout>
...
<LastUpdated date="2025-12-15T21:45:26.840Z" />
