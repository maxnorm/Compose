...
[View Source](https://github.com/maxnorm/Compose/blob/9d31e7ed569453791f4cfdd4ad4c8785f43e1e85/src/diamond/DiamondLoupeFacet.sol)
...
<APIReference
  method="GET"
  endpoint="facetAddress"
  description="Gets the facet address that supports the given selector. If facet is not found return address(0)."
  parameters={[{"name":"_functionSelector","type":"bytes4","required":true,"description":"The function selector."}]}
  response={{"facet":"The facet address."}}
/>
...
<APIReference
  method="GET"
  endpoint="facetFunctionSelectors"
  ...
  parameters={[{"name":"_facet","type":"address","required":true,"description":"The facet address to filter by."}]}
  response={{"facetSelectors":"The function selectors implemented by `_facet`."}}
/>
...
<APIReference
  ...
  parameters={[]}
  response={{"allFacets":"Array of unique facet addresses used by this diamond."}}
/>
...
<APIReference
  ...
  parameters={[]}
  response={{"facetsAndSelectors":"Array of Facet structs, each containing a facet address."}}
/>
