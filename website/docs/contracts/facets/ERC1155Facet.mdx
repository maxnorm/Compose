...
[View Source](https://github.com/maxnorm/Compose/blob/65ccb583222569a74d6694fb4ab182f734624c4c/src/token/ERC1155/ERC1155Facet.sol)
...
<APIReference
  ...
  parameters={[]}
  response={{"s":"The ERC-1155 storage struct reference."}}
/>
...
<APIReference
  ...
  parameters={[{"name":"_id","type":"uint256","required":true,"description":"The token ID to query."}]}
  response={{"result":"The URI for the token type."}}
/>
...
<APIReference
  ...
  parameters={[{"name":"_account","type":"address","required":true,"description":"The address to query the balance of."},{"name":"_id","type":"uint256","required":true,"description":"The token type to query."}]}
  response={{"result":"The balance of the token type."}}
/>
...
<APIReference
  ...
  parameters={[{"name":"_accounts","type":"address[]","required":true,"description":"The addresses to query the balances of."},{"name":"_ids","type":"uint256[]","required":true,"description":"The token types to query."}]}
  response={{"balances":"The balances of the token types."}}
/>
...
<APIReference
  ...
  parameters={[{"name":"_operator","type":"address","required":true,"description":"The address to grant/revoke approval to."},{"name":"_approved","type":"bool","required":true,"description":"True to approve, false to revoke."}]}
/>
...
<APIReference
  ...
  parameters={[{"name":"_account","type":"address","required":true,"description":"The token owner."},{"name":"_operator","type":"address","required":true,"description":"The operator to query."}]}
  response={{"result":"True if the operator is approved, false otherwise."}}
/>
...
<APIReference
  ...
  parameters={[{"name":"_from","type":"address","required":true,"description":"The address to transfer from."},{"name":"_to","type":"address","required":true,"description":"The address to transfer to."},{"name":"_id","type":"uint256","required":true,"description":"The token type to transfer."},{"name":"_value","type":"uint256","required":true,"description":"The amount to transfer."},{"name":"_data","type":"bytes","required":true,"description":"Additional data with no specified format."}]}
/>
...
<APIReference
  ...
  parameters={[{"name":"_from","type":"address","required":true,"description":"The address to transfer from."},{"name":"_to","type":"address","required":true,"description":"The address to transfer to."},{"name":"_ids","type":"uint256[]","required":true,"description":"The token types to transfer."},{"name":"_values","type":"uint256[]","required":true,"description":"The amounts to transfer."},{"name":"_data","type":"bytes","required":true,"description":"Additional data with no specified format."}]}
/>
