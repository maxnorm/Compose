...
- Supports both fungible and non-fungible tokens under a single contract.
- Enables efficient batch operations for balance checks and transfers.
- Provides a flexible URI system for token metadata, allowing for both base and token-specific URIs.
</Callout>

## Overview

The ERC1155Facet implements the ERC-1155 Multi-Token Standard. It provides functions for managing fungible and non-fungible tokens within a Compose diamond, enabling batch transfers, approvals, and token URI resolution.
...
contract ERC1155Consumer {
    ...
    constructor(address _diamondAddress) {
        // Assume the diamond address has been initialized and the ERC1155Facet is cut
        erc1155Facet = IERC1155Facet(_diamondAddress);
    }

    function checkBalance(uint256 _tokenId, address _account) external view returns (uint256) {
        return erc1155Facet.balanceOf(_account, _tokenId);
    }

    function getTokenUri(uint256 _tokenId) external view returns (string memory) {
        return erc1155Facet.uri(_tokenId);
    }
...
- Initialize the ERC1155Facet by calling its cut function during diamond deployment. Ensure the storage slot for ERC1155 state is correctly defined.
- Use &#x60;balanceOfBatch&#x60; and &#x60;safeBatchTransferFrom&#x60; for gas efficiency when dealing with multiple token types or accounts.
- Carefully manage approvals using &#x60;setApprovalForAll&#x60; to prevent unauthorized token transfers.
</Callout>

## Security Considerations

<Callout type="warning" title="Security">
Ensure that &#x60;setApprovalForAll&#x60; is used with trusted operators only. Validate &#x60;_from&#x60; and &#x60;_to&#x60; addresses in transfer functions to prevent accidental loss of tokens. The &#x60;uri&#x60; function&#x27;s concatenation logic requires explicit setting of &#x60;baseURI&#x60; if intended.
</Callout>
...
<LastUpdated date="2025-12-19T19:09:58.576Z" />
