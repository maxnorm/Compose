...
gitSource: "https://github.com/maxnorm/Compose/blob/56196d950dad5f803c271d96961275928a79b519/src/access/AccessControl/AccessControlFacet.sol"
---
...
- Modular role-based access control for diamonds.
- Batch operations for efficient role assignment.
- Support for hierarchical admin roles and permissions management.
</Callout>

## Overview

The AccessControlFacet provides role-based access management for functions within a Compose diamond. It includes functionality to assign, revoke, and verify roles, alongside defining admin role hierarchies. This facet centralizes access control, ensuring modular and maintainable permission handling.
...
contract AccessControlExample {
    ...
    function setupRoles(address admin, address user1, address user2) external {
        diamond.delegatecall(
        ...
        diamond.delegatecall(
            abi.encodeWithSelector(
                ...
                keccak256("USER_ROLE"), // Role identifier
                new address[](2) (user1, user2)
            )
        );
    }
    ...
    function checkRole(address account) external view returns (bool) {
        ...
        require(success, "Error checking role");
...
- Always initialize role hierarchies during diamond setup to maintain clear access patterns.
- Verify external callers have correct roles using &#x60;requireRole&#x60; at the beginning of critical functions.
- When upgrading or replacing the facet, ensure all granted roles and their admin hierarchies match the intended updated implementation.
</Callout>

## Security Considerations

<Callout type="warning" title="Security">
Enforce proper access control on admin-only functions such as &#x60;setRoleAdmin&#x60;, &#x60;grantRole&#x60;, and &#x60;revokeRole&#x60;. Use &#x60;requireRole&#x60; for critical functions to validate permissions explicitly. Guard against common vulnerabilities such as reentrancy if combined with other facets managing funds or state. Validate roles and account addresses in all role-management functions to prevent malicious or unintended updates.
</Callout>
...
<LastUpdated date="2025-12-16T00:44:17.094Z" />
