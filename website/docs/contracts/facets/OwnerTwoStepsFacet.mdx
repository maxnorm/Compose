...
[View Source](https://github.com/maxnorm/Compose/blob/65ccb583222569a74d6694fb4ab182f734624c4c/src/access/OwnerTwoSteps/OwnerTwoSteps.sol)
...
<APIReference
  ...
  parameters={[]}
  response={{"s":"The EOwnerTwoStepsStorage struct in storage."}}
/>
...
<APIReference
  ...
  parameters={[]}
  response={{"result":"The address of the owner."}}
/>
...
<APIReference
  ...
  parameters={[]}
  response={{"result":"The address of the pending owner."}}
/>
...
<APIReference
  ...
  parameters={[{"name":"_newOwner","type":"address","required":true,"description":"The address of the new owner of the contract"}]}
/>
