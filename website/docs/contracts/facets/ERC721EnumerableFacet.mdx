...
description: "**Title:**"
gitSource: "https://github.com/maxnorm/Compose/blob/56196d950dad5f803c271d96961275928a79b519/src/token/ERC721/ERC721Enumerable/ERC721EnumerableFacet.sol"
---
...
- Implements ERC-721 standard with enumerability for token collections.
- Supports safe transfer of tokens, ensuring compatibility with receiver contracts.
</Callout>

## Overview

The ERC721EnumerableFacet extends the Compose diamond with ERC-721 NFT enumeration and manipulation capabilities. It provides functions for managing token metadata, ownership, approvals, transfers, and safe interactions with receiving contracts under the ERC-721 standard.
...
contract DeployDiamond {
    function deployAndUseDiamond() external {
        // Deploy the diamond
        Diamond diamond = new Diamond();

        // Add the ERC721EnumerableFacet
        diamond.addFacet(address(new ERC721EnumerableFacet()));

        // Call functions through the diamond
        address owner = diamond.ownerOf(1);
        uint256 supply = diamond.totalSupply();
        string memory tokenUri = diamond.tokenURI(1);

        // Perform a safe transfer using the diamond
        diamond.safeTransferFrom(msg.sender, owner, 1);
    }
}`}
</ExpandableCode>
...
- Ensure the underlying storage alignment matches the expected layout in the facet.
- Use &#x60;getStorage&#x60; for reading and modifying state variables safely.
- Register function selectors during deployment to ensure full functionality is exposed to the diamond.
</Callout>

## Security Considerations

<Callout type="warning" title="Security">
Validate input parameters like token IDs and recipient addresses to ensure they are valid. Enforce proper access controls on state-changing functions such as &#x60;safeTransferFrom&#x60;, &#x60;transferFrom&#x60;, &#x60;approve&#x60;, and &#x60;setApprovalForAll&#x60;. Consider reentrancy risks in transfer and approval logic, especially in mixed ownership scenarios. Ensure &#x60;getStorage&#x60; is used correctly to prevent mismanagement of state.
</Callout>
...
<LastUpdated date="2025-12-16T00:45:56.493Z" />
