...
description: "A complete, dependency-free ERC-721 implementation with enumeration support using a custom storage layout."
---
...
<DocHero
  title="ERC721EnumerableFacet"
  subtitle="A complete, dependency-free ERC-721 implementation with enumeration support using a custom storage layout."
  variant="gradient"
  height="small"
/>
...
[View Source](https://github.com/maxnorm/Compose/blob/e3e377cf3d77e94dc30e10812da2bdd1907ca159/src/token/ERC721/ERC721Enumerable/ERC721EnumerableFacet.sol)
