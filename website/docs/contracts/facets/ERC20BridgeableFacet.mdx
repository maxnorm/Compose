...
description: "Provides functions and storage layout for ERC20-Bridgeable token logic."
---
...
<DocHero
  title="ERC20BridgeableFacet"
  subtitle="Provides functions and storage layout for ERC20-Bridgeable token logic."
  variant="gradient"
  height="small"
/>
