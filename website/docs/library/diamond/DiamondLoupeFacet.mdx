...
gitSource: "https://github.com/maxnorm/Compose/blob/7e2dd824639f424be644c4ebbb3ca2508167329f/src/diamond/DiamondLoupeFacet.sol"
---
...
- Provides functions to retrieve facet addresses and their associated selectors.
- Optimized for gas efficiency when querying large diamonds with many facets and selectors.
</Callout>

## Overview

The DiamondLoupeFacet provides essential introspection capabilities for a diamond proxy. It allows developers to query which facets are deployed to the diamond, the addresses of those facets, and the specific function selectors each facet handles. This is crucial for understanding the diamond's internal structure and for dynamic interaction.
...
- Integrate DiamondLoupeFacet into your diamond to enable runtime inspection of its composition.
- Use the provided functions to verify facet deployments and understand function routing within your diamond.
</Callout>

## Security Considerations

<Callout type="warning" title="Security">
The functions in this facet are read-only and do not modify diamond state, thus posing no direct reentrancy risk. Ensure that the diamond address passed to this facet is verified to prevent querying unauthorized contracts.
</Callout>
...
<LastUpdated date="2025-12-21T21:55:32.724Z" />
